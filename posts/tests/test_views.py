...
class PagesTest(TestCase):
    ...
    def test_pages_uses_correct_template(self):
        """Проверка шаблонов на соответствие страниц."""
    ...
    def test_post_with_group_in_index(self):
        """Проверка что пост отображается на главной странице."""
        cache.clear()
        response = self.authorized_client.get(reverse("index"))
        self.assertContains(response, PagesTest.group1.slug)

    def test_post_with_group_in_page_group(self):
        """Проверка что пост отображается на странице /group/<slug>/."""
    ...
    def test_about_author_available_anonymous(self):
        """Проверка страницы about:author, что доступна всем пользователям."""
        response = self.anonymous_client.get(reverse_lazy("about:author"))
        status_code = response.status_code
        self.assertEqual(status_code, 200)

    def test_about_tech_available_anonymous(self):
        """Проверка страницы about:tech, что доступна всем пользователям."""
    ...
    def test_context_contains_image(self):
        """Проверка вывода поста с картинкой изображения."""
        tests_urls = {
            "index": None,
    ...
    def test_authorized_user_can_comment(self):
        """Проверка доступности добавления
        комментария авторизованному пользователю."""
    ...
    def test_nonauthorized_user_cannot_comment(self):
        """Проверка не доступности добавления
        комментария гостю сайта."""
